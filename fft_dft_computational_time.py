...
plt.xlabel('x')
plt.ylabel('y')
plt.title('$4sin(2x) - 1.5cos(5x) + 0.3sin(0.5x) + 0.4cos(2x)$', fontdict={'fontsize':18})
plt.show()
...
plt.legend()
plt.title('Time for DFT and FFT with different powers of $2^p$', fontdict={'fontsize':16})
plt.xlabel('p', fontdict={'fontsize':18})
...
ax[0].set_xlabel('p in $2^p$', fontdict={'fontsize':18})
ax[0].set_ylabel('time (s)', fontdict={'fontsize':18})
ax[0].legend()
ax[0].set_title('DFT vs FFT computational time', fontdict={'fontsize':18})

ax[1].plot(n,n2, label='O(N^2)')
ax[1].plot(n,nlogn, label = 'O(NlogN)')
ax[1].set_xlabel('N', fontdict={'fontsize':18})
ax[1].legend()
ax[1].set_title('O(N^2) vs O(NlogN)', fontdict={'fontsize':18})
...
bx[0].set_title('DFT amplitudes', fontdict={'fontsize':18})
bx[0].set_xlabel('frequency', fontdict={'fontsize':18})
bx[0].set_ylabel('amplitude', fontdict={'fontsize':18})

bx[1].stem(freqs[:20], ampsF[:20], label='Average amplitudes')
bx[1].set_title('FFT amplitudes', fontdict={'fontsize':18})
bx[1].set_xlabel('frequency', fontdict={'fontsize':18})
...
plt.title('Abs error between DFT and FFT coefficient', fontdict={'fontsize':18})
plt.xlabel('frequency', fontdict={'fontsize':18})
plt.ylabel('abs error', fontdict={'fontsize':18})
plt.tight_layout()
