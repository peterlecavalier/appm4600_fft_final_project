...
print("The size before compression: {}".format(sys.getsizeof(fft)))
print()
...
for i in amount_compression:
    ...
    print("The size after compression of {}%: {}".format(i*100, sys.getsizeof(compressedfft)))
    print("This is {:.2f}% of the original size".format(sys.getsizeof(compressedfft)/sys.getsizeof(fft) * 100))
    print()
...
print(sys.getsizeof(compressedfft))
print(sys.getsizeof(fft))
